...
// AIRLIFT PATCH (PyPortal-Pynt-RTK): MOSI moved 12 -> 14. Adafruit AirLift
// boards route host-MOSI to ESP32 GPIO14 (GPIO12 is the MTDI flash-voltage
// strap on the AirLift layout); every other pin matches upstream. This is
// the ONLY source change vs. arduino/nina-fw 3.0.1 (tag 57d12f4).

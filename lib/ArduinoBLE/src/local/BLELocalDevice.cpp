...
// AIRLIFT PATCH (PyPortal-Pynt-RTK): BLE_NINA_SPI_TRANSPORT opt-in, see
// utility/HCINinaSpiTransport.cpp.
#if defined(ARDUINO_AVR_UNO_WIFI_REV2) || defined(ARDUINO_SAMD_MKRWIFI1010) || defined(ARDUINO_SAMD_NANO_33_IOT) || defined(TARGET_NANO_RP2040_CONNECT) || defined(BLE_NINA_SPI_TRANSPORT)
